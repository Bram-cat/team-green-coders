...
import { AIRoofAnalysis } from "../ai/openaiService";
  ...
  return [
    {
      angle: "aerial",
      description:
        "Aerial view showing the complete solar panel layout on your roof",
...
Style: Photorealistic architectural visualization, bright daylight, high quality, professional real estate photography style`,
    },
    {
      angle: "south",
      description:
        "Ground-level view from the south showing the panel face and installation details",
...
Style: Photorealistic, professional installation photography, bright daylight, showcasing the quality and scale of the installation`,
    },
    {
      angle: "west",
      description:
        "Side perspective view showing the panel profile and roof integration",
 ...
 */
export function getAngleDescriptions(): Record<
  "aerial" | "south" | "west",
  string
> {
  return {
    ...
    south:
      "Front view displaying panel face, tilt angle, and installation quality",
